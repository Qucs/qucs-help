...
2.5 SPICE DC simulation
~~~~~~~~~~~~~~~~~~~~~~~~


Conventional SPICE simulation commands .OP and .DC are not implemented by Qucs or indeed by spice4qucs.
...
This procedure is demonstrated in Figure 2.10. where  the test circuit consists of a diode DC bias network connected as a test bench for simulating the non-linear DC current-voltage characteristic 
...
SPICE OPUS also supports large signal steady state analysis using shooting methods.  This useful RF type of simulation is implemented
by spice4qucs using a special *Custom simulation" technique described in chapter 8 of this document.

Fourier and Distortion analysis require special components. These are located in the Qucs *Spice simulations* group. Fourier, sensitivity and distortion circuit simulation are again controlled
by *spice4qucs* using the special *Custom simulation* technique. 
